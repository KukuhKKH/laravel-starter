...
namespace Illuminate\Support\Facades {
     ...
     */        class Response {
         ...
         * 
         *
         * @see \BangLipai\Utility\ResponseServiceProvider::boot()
         * @param mixed $data
         * @param int|null $code
         * @param array|null $meta
         * @return array 
         * @static 
         */        public static function format($data, $code, $meta)
        {
                        return \Illuminate\Routing\ResponseFactory::format($data, $code, $meta);
        }
                    /**
         * 
         *
         ...
         * @return array 
         * @static 
         */        public static function formatSuccess($data, $code, $meta)
        {
                        return \Illuminate\Routing\ResponseFactory::formatSuccess($data, $code, $meta);
        }
                    /**
         * 
         *
...
namespace Illuminate\Database\Schema {
     ...
     */        class Blueprint {
         ...
         * 
         *
         * @see \BangLipai\Utility\MigrationServiceProvider::register()
         * @param int $singkat
         * @param int $keterangan
         * @param bool $nullable
         * @static 
         */        public static function masterColumn($singkat = 9, $keterangan = 50, $nullable = true)
        {
        ...
        {
                        return \Illuminate\Database\Schema\Blueprint::master($name);
        }
                    /**
         * 
         *
         ...
         * @return \Illuminate\Database\Schema\ColumnDefinition 
         * @static 
         */        public static function wkt($name)
        {
                        return \Illuminate\Database\Schema\Blueprint::wkt($name);
        }
                    /**
         * 
         *
         ...
         * @return \Illuminate\Database\Schema\ColumnDefinition 
         * @static 
         */        public static function tgl($name)
        {
                        return \Illuminate\Database\Schema\Blueprint::tgl($name);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Database\Schema\Blueprint::is($name);
        }
                    /**
         * 
         *
...
namespace Illuminate\Testing {
     ...
     */        class TestResponse {
         ...
         * @static 
         */        public static function assertSuccess($data = null, $status = 200, $code = null, $meta = null)
        {
                        return \Illuminate\Testing\TestResponse::assertSuccess($data, $status, $code, $meta);
        }
                    /**
         * 
         *
         ...
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertError($message = null, $data = null, $status = 500, $code = null, $meta = null)
        {
                        return \Illuminate\Testing\TestResponse::assertError($message, $data, $status, $code, $meta);
        }
            }
    }
